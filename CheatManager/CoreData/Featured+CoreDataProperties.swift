//
//  Featured+CoreDataProperties.swift
//  CheatManager
//
...
extension Featured {
    @nonobjc public class func fetchRequest() -> NSFetchRequest<Featured> {
        return NSFetchRequest<Featured>(entityName: "Featured")
    }

    // Data to create StoreCheat object
    ...
    //  Data to create StoreGame object
    @NSManaged public var game_id: String
    @NSManaged public var game_category: String
    @NSManaged public var game_version: Double
    @NSManaged public var game_name: String
    @NSManaged public var game_bundleid: String
...
extension Featured : Identifiable {
